...
[
    ...
    ['delete', 'account/:id', handler.deleteAccount, 'admin'],
    ...
    ['get', 'accountDetails/:id', handler.getAccountDetails, 'customer'],
    ...
    ['get', 'scheduled-transactions', handler.getScheduledTransactions, 'customer']
].forEach((r) => {
